...
const MiddleWrapper = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: `Mechanism to  allow users to rate product in ration shops in order to build trust through reputation.`
    }
  ]
  return (
    <div className="middle-wrapper">
      <h5 className="mw-heading" >
        Stay <b>"Consumer Ready"</b> with Blockchain Powered End-To-End Food Distribution Platform
      </h5>
